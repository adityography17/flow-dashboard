...
const getStyles = (dark) => `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  body{font-family:'DM Sans',sans-serif;background:${dark?"#0F172A":"linear-gradient(135deg, #FFECD2, #FCB69F, #FFD6A0, #FEE2C8, #F0F4FF, #E0D4F7, #D4E4FF, #FFECD2)"};background-size:400% 400%;background-attachment:fixed;animation:gradientShift 25s ease infinite;color:var(--ink);font-size:14.5px;line-height:1.55;}
  ...
  .sidebar{width:var(--sidebar-w);background:rgba(255,255,255,0.75);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-right:1px solid rgba(255,255,255,0.5);display:flex;flex-direction:column;position:fixed;top:0;left:0;bottom:0;z-index:100;overflow-y:auto;}
  ...
  .login-page{min-height:100vh;background:linear-gradient(135deg, #FFECD2, #FCB69F, #FFD6A0, #FEE2C8, #F0F4FF, #E0D4F7, #D4E4FF, #FFECD2);background-size:400% 400%;animation:gradientShift 25s ease infinite;display:flex;align-items:center;justify-content:center;padding:20px;position:relative;overflow:hidden;}
